...
class AddEtude extends StatefulWidget {
  AddEtude({Key? key}) : super(key: key);

  @override
  State<AddEtude> createState() => _AddEtudeState();
}

class _AddEtudeState extends State<AddEtude> {
                      ...
                      child: Container(
                        ...
                        child: Table(
                          children: [
                            ...
                            TableRow(children: [
                              Container(height: 35, child: Text("Description")),
                              Container(
                                width: Get.width * .8,
                                height: 75,
                                child: TextField(
